...
function cambiarIdiomaSol(idioma) {
    if (idioma === 'es') {
        ...
        document.getElementById('menu-lista_planetas-urano').innerHTML = 'Urano';
        document.getElementById('menu-lista_planetas-neptuno').innerHTML = 'Neptuno';
        document.getElementById('titulo-sol').innerHTML = 'sol';
        document.getElementById('primero-article-sol').innerHTML = 'etimologia';
        ...
        document.getElementById('uno-sol').innerHTML = 'Se clasifica como una estrella tipo es- pectral G2 y clase de luminosidad V: una estrella “G2V”.';
        ...
        document.getElementById('menu-lista_planetas-urano').innerHTML = 'Uranus';
        document.getElementById('menu-lista_planetas-neptuno').innerHTML = 'Neptune';
        document.getElementById('titulo-sol').innerHTML = 'sun';
...
function cambiarIdiomaJupiter(idioma) {
    if (idioma === 'es') {
        ...
        document.getElementById('menu-lista_planetas-urano').innerHTML = 'Urano';
        document.getElementById('menu-lista_planetas-neptuno').innerHTML = 'Neptuno';
        document.getElementById('titulo-jupiter').innerHTML = 'júpiter';
        ...
        document.getElementById('segundo-article-jupiter').innerHTML = 'precipitaciones';
        ...
        document.getElementById('menu-lista_planetas-urano').innerHTML = 'Uranus';
        document.getElementById('menu-lista_planetas-neptuno').innerHTML = 'Neptune';
        document.getElementById('titulo-jupiter').innerHTML = 'Jupiter';
...
function cambiarIdiomaSaturno(idioma) {
    if (idioma === 'es') {
        ...
        document.getElementById('menu-lista_planetas-urano').innerHTML = 'Urano';
        document.getElementById('menu-lista_planetas-neptuno').innerHTML = 'Neptuno';
        document.getElementById('titulo-saturno').innerHTML = 'saturno';
        ...
        document.getElementById('menu-lista_planetas-urano').innerHTML = 'Uranus';
        document.getElementById('menu-lista_planetas-neptuno').innerHTML = 'Neptune';
        document.getElementById('titulo-saturno').innerHTML = 'saturn';
        document.getElementById('primero-article-saturno').innerHTML = 'etimologia';
