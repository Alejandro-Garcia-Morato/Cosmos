function cambiarIdiomaHome(idioma) {
    if (idioma === "es") {
        ...
        document.getElementById("menu-lista_planetas-mercurio").innerHTML =
            "Mercurio";
        ...
        document.getElementById("menu-lista_planetas-jupiter").innerHTML =
            "Júpiter";
        document.getElementById("menu-lista_planetas-saturno").innerHTML =
            "Saturno";
        document.getElementById("menu-lista_planetas-urano").innerHTML = "Urano";
        document.getElementById("menu-lista_planetas-neptuno").innerHTML =
            "Neptuno";
        document.getElementById("header-titulo").innerHTML = "Descubre el cosmos";
        document.getElementById("header-subtitulo").innerHTML =
            '"El cosmos es todo lo que es, todo lo que fue y todo lo que alguna vez será" - Carl Sagan';
        document.getElementById("home-articulo-planeta-titulo_sol").innerHTML =
            "Sol";
        document.getElementById("home-articulo-planeta-titulo_mercurio").innerHTML =
            "Mercurio";
        document.getElementById("home-articulo-planeta-titulo_tierra").innerHTML =
            "Tierra";
        document.getElementById("home-articulo-planeta-titulo_luna").innerHTML =
            "Luna";
        document.getElementById("home-articulo-planeta-titulo_marte").innerHTML =
            "Marte";
        document.getElementById("home-articulo-planeta-titulo_jupiter").innerHTML =
            "Júpiter";
        document.getElementById("home-articulo-planeta-titulo_saturno").innerHTML =
            "Saturno";
        document.getElementById("home-articulo-planeta-titulo_urano").innerHTML =
            "Urano";
        document.getElementById("home-articulo-planeta-titulo_neptuno").innerHTML =
            "Neptuno";
        ...
        document.getElementById("footer-info").innerHTML =
            "The students of Marina Martínez Bonat in the 3rd year of ESO A, B and C and the students of Alicia Portero Hernández have participated in the development of this website within the training program in STEAM competences in which the IES Juan Bosco from Alcázar de San Juan participates";
        document.getElementById("footer-copy").innerHTML =
...
function cambiarIdiomaSol(idioma) {
    if (idioma === "es") {
        ...
        document.getElementById("etimologia-sol").innerHTML =
            "Su nombre viene del latín sol, que era como los romanos llamaban al astro brillante que les ofrecía la luz del día.";
        document.getElementById("segundo-article-sol").innerHTML = "información";
        document.getElementById("uno-sol").innerHTML =
            "Se clasifica como una estrella tipo espectral G2 y clase de luminosidad V: una estrella “G2V”.";
        document.getElementById("dos-sol").innerHTML =
            "MEDIDAS: Diámetro de 1,3927 millones de km y radio de 696.340 km.";
        ...
        document.getElementById("etimologia-sol").innerHTML =
            "Its name comes from the Latin sun, which was how the Romans called the star brilliant that the light of day offered them.";
        ...
        document.getElementById("uno-aside-sol").innerHTML =
            " Although we see that it is yellow, it is actually white.";
        document.getElementById("dos-aside-sol").innerHTML =
            " Its surface temperature is 5,778 K.";
        document.getElementById("tres-aside-sol").innerHTML =
            " It has a gravity of 274 m/s².";
        document.getElementById("footer-desarrolladores").innerHTML =
            "Page developed by: Teresa María Fontela Lorenzo | Izan Gallego Torres | Alejandro García-Morato Ramos";
        document.getElementById("footer-info").innerHTML =
            "The students of Marina Martínez Bonat in the 3rd year of ESO A, B and C and the students of Alicia Portero Hernández have participated in the development of this website within the training program in STEAM competences in which the IES Juan Bosco from Alcázar de San Juan participates";
...
function cambiarIdiomaMercurio(idioma) {
    if (idioma === "es") {
        ...
        document.getElementById("menu-lista_planetas-neptuno").innerHTML =
            "Neptuno";
        document.getElementById("main-cabecera-titulo-mercurio").innerHTML =
            "mercurio";
        ...
        document.getElementById("articulo-planetas-texto-informacion1").innerHTML =
            "La duración de un día equivale a 58'6 días terrestres. Un año equivale a 87'87 días terrestres.";
        document.getElementById("articulo-planetas-texto-informacion2").innerHTML =
            "La temperatura del agua tiene una media de -160º pudiendo alcanzar los -180º de noche y 160º de día. Hay agua en estado gaseoso y en hielo.";
        ...
        document.getElementById("aside-planetas-texto1").innerHTML =
            " Para llegar desde la Tierra se tardan 40 días.";
        document.getElementById("aside-planetas-texto2").innerHTML =
            " Está a unos 80.000 kilómetros desde la Tierra.";
        ...
        document.getElementById("articulo-planetas-titulo-etimologia").innerHTML =
            "etymology";
        document.getElementById("articulo-planetas-texto-etimologia").innerHTML =
            "Its name comes from Roman mythology, which is the equivalent of Hermes: Mercury.";
        document.getElementById("articulo-planetas-titulo-informacion").innerHTML =
            "information";
        document.getElementById("articulo-planetas-texto-informacion1").innerHTML =
            "The length of a day is equal to 58.6 Earth days. One year equals 87.87 Earth days.";
        document.getElementById("articulo-planetas-texto-informacion2").innerHTML =
            "The water temperature has an average of -160º and can reach -180º at night and 160º during the day. There is water in a gaseous state and in ice.";
        document.getElementById("articulo-planetas-texto-informacion3").innerHTML =
...
function cambiarIdiomaTierra(idioma) {
    if (idioma === "es") {
        ...
        document.getElementById("menu-lista_planetas-neptuno").innerHTML =
            "Neptuno";
        document.getElementById("main-cabecera-titulo-tierra").innerHTML =
            "la tierra";
        document.getElementById("articulo-planetas-titulo-etimologia").innerHTML =
            "etimología";
        document.getElementById("articulo-planetas-texto-etimologia").innerHTML =
        ...
        document.getElementById("articulo-planetas-titulo-etimologia").innerHTML =
            "etymology";
        document.getElementById("articulo-planetas-texto-etimologia").innerHTML =
            'Its name comes from the Latin "terra" with the same meaning as ours and related to the verb "torror", which means to dry or singe.';
        document.getElementById("articulo-planetas-titulo-informacion").innerHTML =
            "information";
        document.getElementById("articulo-planetas-texto-informacion1").innerHTML =
            "The average temperature is 15º thanks to the presence of greenhouse gases in the atmosphere.";
        document.getElementById("articulo-planetas-texto-informacion2").innerHTML =
...
function cambiarIdiomaLuna(idioma) {
    if (idioma === "es") {
        ...
        document.getElementById("articulo-planetas-titulo-etimologia").innerHTML =
            "etimología";
        document.getElementById("articulo-planetas-texto-etimologia").innerHTML =
            "Su nombre proviene del latín luna, cuya forma arcaica era leuksna y después louksna. La unión de leuks (luz) y el sufijo -na significa luminosa.";
        document.getElementById("articulo-planetas-titulo-informacion").innerHTML =
            "información";
        document.getElementById("articulo-planetas-texto-informacion1").innerHTML =
            "Las fases lunares son cuatro: nueva, cuarto creciente, luna llena y cuarto menguante.";
        document.getElementById("articulo-planetas-texto-informacion2").innerHTML =
        ...
        document.getElementById("articulo-planetas-titulo-etimologia").innerHTML =
            "etymology";
        document.getElementById("articulo-planetas-texto-etimologia").innerHTML =
            "Its name comes from the Latin luna, whose archaic form was leuksna and later louksna. The union of leuks (light) and the suffix -na means bright.";
        document.getElementById("articulo-planetas-titulo-informacion").innerHTML =
            "information";
        document.getElementById("articulo-planetas-texto-informacion1").innerHTML =
            "There are four lunar phases: new, first quarter, full moon, and last quarter.";
        document.getElementById("articulo-planetas-texto-informacion2").innerHTML =
            "Astro closest to Earth (384,400 km) and natural satellite of our planet and the second largest in the solar system.";
        document.getElementById("articulo-planetas-texto-informacion3").innerHTML =
            "The moon has a diameter of 2474.8 km. Its surface is full of craters produced by meteorite impacts because the moon has no atmosphere.";
        document.getElementById("articulo-planetas-texto-informacion4").innerHTML =
            "Rotation period: 27.3 days. Translation period: 27.3 days. That's why we always see the same side of the moon.";
        document.getElementById("articulo-planetas-texto-informacion5").innerHTML =
            "Gravity is less than on Earth (1.62m/s2). A person who weighs 45 kilos on the Moon would weigh 8.05 kilos.";
        document.getElementById("aside-titulo").innerHTML = "Fun facts:";
        document.getElementById("aside-planetas-texto1").innerHTML =
        ...
        document.getElementById("aside-planetas-texto4").innerHTML =
            " Did you know that Mercury and Venus are the only planets in the solar system that do not have satellites?";
        document.getElementById("footer-desarrolladores").innerHTML =
            "Page developed by: Teresa María Fontela Lorenzo | Izan Gallego Torres | Alejandro García-Morato Ramos";
        document.getElementById("footer-info").innerHTML =
            "The students of Marina Martínez Bonat in the 3rd year of ESO A, B and C and the students of Alicia Portero Hernández have participated in the development of this website within the training program in STEAM competences in which the IES Juan Bosco from Alcázar de San Juan participates";
...
function cambiarIdiomaMarte(idioma) {
    if (idioma === "es") {
        ...
        document.getElementById("articulo-planetas-marte-etimologia").innerHTML =
            "etimología";
...
function cambiarIdiomaJupiter(idioma) {
    if (idioma === "es") {
        ...
        document.getElementById("menu-lista_planetas-neptuno").innerHTML =
            "Neptuno";
        document.getElementById("main-cabecera-titulo-jupiter").innerHTML =
            "júpiter";
        document.getElementById("primero-article-jupiter").innerHTML = "etimología";
        document.getElementById("etimologia-jupiter").innerHTML =
            'Júpiter deriva de Ius-piter, o sea, últimamente de Deus-pater "dios padre".';
        ...
        document.getElementById("etimologia-jupiter").innerHTML =
            'Jupiter derives from Ius-piter, that is, ultimately from Deus-pater "father god".';
        document.getElementById("segundo-article-jupiter").innerHTML =
            "information";
        document.getElementById("uno-segundo-jupiter").innerHTML =
        ...
        document.getElementById("uno-aside-jupiter").innerHTML =
            " The day lasts 9h 56m full day temperature. 4:56h at night and 5h during the day.";
        document.getElementById("dos-aside-jupiter").innerHTML =
            " Undoubtedly, one of the most fascinating aspects of Jupiter is its atmosphere, mainly composed of more than 80% hydrogen in addition to large proportions of helium, ammonia and ethane.";
        document.getElementById("footer-desarrolladores").innerHTML =
            "Page developed by: Teresa María Fontela Lorenzo | Izan Gallego Torres | Alejandro García-Morato Ramos";
        document.getElementById("footer-info").innerHTML =
            "The students of Marina Martínez Bonat in the 3rd year of ESO A, B and C and the students of Alicia Portero Hernández have participated in the development of this website within the training program in STEAM competences in which the IES Juan Bosco from Alcázar de San Juan participates";
...
function cambiarIdiomaSaturno(idioma) {
    if (idioma === "es") {
        ...
        document.getElementById("menu-lista_planetas-neptuno").innerHTML =
            "Neptuno";
        document.getElementById("main-cabecera-titulo-saturno").innerHTML =
            "saturno";
        document.getElementById("primero-article-saturno").innerHTML = "etimología";
        document.getElementById("etimologia-saturno").innerHTML =
        ...
        document.getElementById("segundo-article-saturno").innerHTML =
            "information";
        document.getElementById("uno-segundo-saturno").innerHTML =
            "WATER: A study carried out by the University of Leicester has detected that water exists in the atmosphere.";
        document.getElementById("dos-segundo-saturno").innerHTML =
...
function cambiarIdiomaUrano(idioma) {
    if (idioma === "es") {
        ...
        document.getElementById("articulo-planetas-urano-etimologia").innerHTML =
            "etimología";
        document.getElementById(
...
function cambiarIdiomaNeptuno(idioma) {
    if (idioma === "es") {
        ...
        document.getElementById("menu-lista_planetas-neptuno").innerHTML =
            "Neptuno";
        document.getElementById("main-cabecera-titulo-neptuno").innerHTML =
            "neptuno";
        document.getElementById("articulo-planetas-neptuno-etimologia").innerHTML =
            "etimología";
        document.getElementById(
